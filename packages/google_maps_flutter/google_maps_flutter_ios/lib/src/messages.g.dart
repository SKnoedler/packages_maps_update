...
abstract class MapsCallbackApi {
  ...
  static void setUp(MapsCallbackApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.google_maps_flutter_ios.MapsCallbackApi.onPoiClick$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.google_maps_flutter_ios.MapsCallbackApi.onPoiClick was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PlatformLatLng? arg_position = (args[0] as PlatformLatLng?);
          assert(arg_position != null,
              'Argument for dev.flutter.pigeon.google_maps_flutter_ios.MapsCallbackApi.onPoiClick was null, expected non-null PlatformLatLng.');
          final String? arg_name = (args[1] as String?);
          assert(arg_name != null,
              'Argument for dev.flutter.pigeon.google_maps_flutter_ios.MapsCallbackApi.onPoiClick was null, expected non-null String.');
          final String? arg_placeId = (args[2] as String?);
          assert(arg_placeId != null,
              'Argument for dev.flutter.pigeon.google_maps_flutter_ios.MapsCallbackApi.onPoiClick was null, expected non-null String.');
          try {
            api.onPoiClick(arg_position!, arg_name!, arg_placeId!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
